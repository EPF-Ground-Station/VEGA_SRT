...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayout.addWidget(
            self.pushButton_Connect, 0, Qt.AlignHCenter)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate(
            "Form", u"IP Address", None))
        self.label_3.setText(QCoreApplication.translate("Form", u"Port", None))
        self.pushButton_Connect.setText(
            QCoreApplication.translate("Form", u"Connect", None))
        self.label_2.setText(
            QCoreApplication.translate("Form", u"Status:", None))
        self.label_Status.setText(
            QCoreApplication.translate("Form", u"TextLabel", None))
        self.lineEdit_ipAddress.setText(QCoreApplication.translate(
            "Form", u"127.0.0.1", None))
    # retranslateUi
